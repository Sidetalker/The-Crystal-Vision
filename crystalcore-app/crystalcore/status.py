...
# Tags the project stands on — not AGI claims, not corporate affiliation.
...
def _ollama_tags(timeout: float = 2.0) -> dict[str, Any]:
    ...
    except Exception as e:  # noqa: BLE001 — status must always return
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if args.output:
        ...
        print(text)
    return 0  # informational: offline Ollama is still a valid status report
